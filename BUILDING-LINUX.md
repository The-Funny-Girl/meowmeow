...
The Linux target provides native application startup, XDG path discovery, persistent validated settings, private directory creation, bounded file I/O, atomic text-file replacement, logging, locked temporary workspace lifecycle management, stale workspace cleanup, runtime health checks, a command-line interface, automated tests, packaging, and CI builds.
